...
if(window.top != window.self){
	...
	if(welive_lang == "Auto"){
		...
		if(welive_lang == 'zh-cn' || welive_lang == 'zh-tw')  welive_mylang = 1; //'zh-cn' and 'zh-tw' should be changed According to your language
	...
	//开始加载窗口
	var welive_is_mobile = navigator.userAgent.match(/(iPhone|Android|iPod|ios|iPad|Windows ce|Windows mobile|Micromessenger|webOS|Ucweb|BlackBerry|midp|rv:1.2.3.4)/i);
	...
	function welive_mobile(){
		...
		welive_css.setAttribute("href", welive_url + "mobile/welive.css?v=510");
		...
		welive_obj.drag.onclick = function(){
			...
			if(!welive_loaded) {
				...
				$_$("welive_iframe").src = welive_url + "mobile/welive_index.php?a=621256768&gid=" + welive_gid + "&r=" + Math.random() + "&d=" + welive_same + "&url=" + url;
			}
	...
	function welive_web(){
		...
		var welive_css = document.createElement("link");
		welive_css.setAttribute("rel", "stylesheet");
		welive_css.setAttribute("href", welive_url + "public/welive.css?v=510");
		document.getElementsByTagName("head")[0].appendChild(welive_css);

		var welive_c = '<div id="welive_online" style="background-color:' + welive_panel_color + '">'+
				'<div id="welive_info"><img src="' + welive_url + 'public/img/small_icon.gif">' + (welive_mylang? 'Click for Online Support ...' : 'Click for Online Support ...') + '</div>'+
		...
		welive_online.onclick = function(){
			...
			if(!welive_loaded) {
				...
				location.hash = "";
				var url = window.location.href;
				$_$("welive_iframe").src = welive_url + "welive2628.php?a=621256768&gid=" + welive_gid + "&r=" + Math.random() + "&d=" + welive_same + "&url=" + url;
			}
