...
//正式开始
$a = intval($_GET['a']);
if($a !== 621256768) die('Access denied.'); //简单地防止直接访问当前文件(并不重要)
...
<link rel="stylesheet" href="public/guest.css?v=510">
...
guest = {gid: ' . $gid . ', fn: "", aid: 0, au: 0, an: "", sess: "", lang: ' . IS_MYLANG . ', agent: "' . $agent . '", fromurl: "' . $fromurl . '"},
welcome = "' . encodeChar(Iif(IS_MYLANG, $_CFG['Welcome'], $_CFG['Welcome_en'])) . '",
comment_note = "' . encodeChar(Iif(IS_MYLANG, $_CFG['Comment_note'], $_CFG['Comment_note_en'])) . '",
...
<script type="text/javascript" src="public/guest_free.js?v=510"></script>
</body>
</html>';
